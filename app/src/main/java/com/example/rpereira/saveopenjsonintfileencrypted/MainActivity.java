package com.example.rpereira.saveopenjsonintfileencrypted;
...
import com.example.rpereira.saveopenjsonintfileencrypted.model.Person;
import com.example.rpereira.saveopenjsonintfileencrypted.security.Security;
        ...
        mbtnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!medtName.getText().toString().isEmpty() && !medtLastname.getText().toString().isEmpty() &&
                    ...
                    // Encrypt
                    String encryptedString = Security.encrypt(jsonString);
                    ...
                    if (!jsonString.isEmpty()) {
                        ...
                        try {
                            ...
                            Log.i("JSON", "Encryrpted: "+encryptedString);
                            toastMsg("Json salvo.");
                            cleamFields();
        ...
        mbtnOpen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    // Decrypt String
                    decryptedString = Security.decrypt(jsonRecovered);
                ...
                if(!decryptedString.isEmpty()) {
                    ...
                    Person person = gson.fromJson(decryptedString, Person.class);
